...
public class ArticlesListingController : RenderController
{
    public ArticlesListingController(
    ...
    public override IActionResult Index()
    {
        ...
        var page = CurrentPage.SafeCast<ArticlesListing>();
        var home = CurrentPage.Root<Home>();
        var pageViewModel = ArticlesListingViewModel.Create(home, page);
